 ...
 * @brief A QtQuick item that follows a ROS String published on a topic 'topic'.
 */
class RosFloatSubscriber : public QQuickItem {
Q_OBJECT
    Q_PROPERTY(QString text MEMBER _text NOTIFY onTextChanged)
    Q_PROPERTY(QString topic WRITE setTopic MEMBER _topic)
...
public:
    ...
    RosFloatSubscriber(QQuickItem* parent = 0){}

    virtual ~RosFloatSubscriber() {}

    void setTopic(QString topic);
    void onIncomingString(const std_msgs::Float32 &data);
 ...
 *
 */
class RosFloatPublisher : public QQuickItem {
Q_OBJECT
    Q_PROPERTY(QString topic WRITE setTopic MEMBER _topic)
    Q_PROPERTY(QString text WRITE setText MEMBER _text )

public:
    RosFloatPublisher(QQuickItem* parent = 0){}
    virtual ~RosFloatPublisher() {}
